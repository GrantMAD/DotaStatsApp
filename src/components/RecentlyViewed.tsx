...
export default function RecentlyViewed({ onPressItem, refreshTrigger = 0 }: Props) {
              ...
              <View style={{
                ...
                <View style={{ flex: 1, justifyContent: 'center' }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 2 }}>
                    <Text style={{ color: '#64748b', fontSize: 10, fontWeight: '600' }} numberOfLines={1}>
                      {formatDistanceToNow(new Date(item.timestamp), { addSuffix: false })} ago
                    </Text>
                  </View>
                </View>

                <Ionicons name="chevron-forward" size={14} color="#2a2a3e" style={{ marginLeft: 4 }} />
              </View>
            </PressableScale>
          </Animated.View>
        ))}
